...
class RegistroInscripcionesForm(forms.Form):
	...
	# lectura_critica = forms.IntegerField(label="Lectura crítica",widget=forms.TextInput(attrs={'required': True,'type':"number",'class':"form-control",'placeholder':'Resultado de Lectura crítica'}))
	# matematicas = forms.IntegerField(label="Matemáticas",widget=forms.TextInput(attrs={'required': True,'type':"number",'class':"form-control",'placeholder':'Resultado de Matemáticas'}))
	# sociales = forms.IntegerField(label="Sociales",widget=forms.TextInput(attrs={'required': True,'type':"number",'class':"form-control",'placeholder':'Resultado de Sociales'}))
	# naturales = forms.IntegerField(label="Naturales",widget=forms.TextInput(attrs={'required': True,'type':"number",'class':"form-control",'placeholder':'Resultado de Naturales'}))
	# ingles = forms.IntegerField(label="Inglés",widget=forms.TextInput(attrs={'required': True,'type':"number",'class':"form-control",'placeholder':'Resultado de Inglés'}))
	# razonamiento_cuantitativo = forms.IntegerField(label="Razonamiento cuantitativo",widget=forms.TextInput(attrs={'required': True,'type':"number",'class':"form-control",'placeholder':'Resultado de Razonamiento cuantitativo'}))
	# competencias_ciudadanas = forms.IntegerField(label="Competencias ciudadanas",widget=forms.TextInput(attrs={'required': True,'type':"number",'class':"form-control",'placeholder':'Resultado de Competencias ciudadanas'}))
